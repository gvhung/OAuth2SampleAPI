...
namespace PatientJourney.DataAccess.Data
{
    ...
    public partial class Clinical_Intervention_Master
    {
        public Clinical_Intervention_Master()
        {
            this.Patient_Journey_Trans_Clin_Interventions = new HashSet<Patient_Journey_Trans_Clin_Interventions>();
            this.Patient_Journey_Trans_Clin_Interventions_Temp = new HashSet<Patient_Journey_Trans_Clin_Interventions_Temp>();
        }
    
        public int Clinical_Intervention_Master_Id { get; set; }
        ...
        public virtual ICollection<Patient_Journey_Trans_Clin_Interventions> Patient_Journey_Trans_Clin_Interventions { get; set; }
